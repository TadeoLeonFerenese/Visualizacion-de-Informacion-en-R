...
Este estudio se centra en dos aspectos cruciales de la actividad tornádica en los Estados Unidos. En primer lugar, operamos los datos mediante una tabla con con columnas imponentes en información, donde filtramos los diez estados más afectados con la cantidad de tornados, los heridos, los muertos y la pérdida en obras que causaron dichas catástrofes; proporcionando una visión precisa de la magnitud de este fenómeno en un área específica del país. Además, utilizando un gráfico de barras exploramos cómo varía la distribución de los tornados a lo largo de los meses en diferentes estados, con el fin de comprender las fluctuaciones estacionales en la actividad tornádica en todo el territorio continental.
